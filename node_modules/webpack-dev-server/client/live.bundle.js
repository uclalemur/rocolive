...
const stripAnsi = __webpack_require__(1);
...
$(function ready() {
  $('body').html(__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./page.pug\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))());
  const status = $('#status');
  const okness = $('#okness');
  const $errors = $('#errors');
  const iframe = $('#iframe');
...
const SockJS = __webpack_require__(4);
