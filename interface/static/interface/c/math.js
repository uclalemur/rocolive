...
Blockly.C['math_number_property'] = function(block) {
    ...
    if (dropdown_property == 'PRIME') {
        ...
        var functionName = Blockly.C.provideFunction_(
            'mathIsPrime', ['function ' + Blockly.C.FUNCTION_NAME_PLACEHOLDER_ + '(n) {',
...
Blockly.C['math_on_list'] = function(block) {
    ...
    switch (func) {
        ...
        case 'AVERAGE':
            ...
            var functionName = Blockly.C.provideFunction_(
                'mathMean', ['function ' + Blockly.C.FUNCTION_NAME_PLACEHOLDER_ +
                    '(myList) {',
        ...
        case 'MEDIAN':
            ...
            var functionName = Blockly.C.provideFunction_(
                'mathMedian', ['function ' + Blockly.C.FUNCTION_NAME_PLACEHOLDER_ +
                    '(myList) {',
        ...
        case 'MODE':
            ...
            var functionName = Blockly.C.provideFunction_(
                'mathModes', ['function ' + Blockly.C.FUNCTION_NAME_PLACEHOLDER_ +
                    '(values) {',
                    '  var modes = [];',
                    '  var counts = [];',
                    '  var maxCount = 0;',
        ...
        case 'STD_DEV':
            var functionName = Blockly.C.provideFunction_(
                'mathStandardDeviation', ['function ' + Blockly.C.FUNCTION_NAME_PLACEHOLDER_ +
                    '(numbers) {',
        ...
        case 'RANDOM':
            var functionName = Blockly.C.provideFunction_(
                'mathRandomList', ['function ' + Blockly.C.FUNCTION_NAME_PLACEHOLDER_ +
                    '(list) {',
...
Blockly.C['math_random_int'] = function(block) {
    ...
    var argument1 = Blockly.C.valueToCode(block, 'TO',
        Blockly.C.ORDER_COMMA) || '0';
    var functionName = Blockly.C.provideFunction_(
        'mathRandomInt', ['function ' + Blockly.C.FUNCTION_NAME_PLACEHOLDER_ +
            '(a, b) {',
            '  if (a > b) {',
