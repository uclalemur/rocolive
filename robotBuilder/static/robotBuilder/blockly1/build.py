...
\\*/""")
            ...
            if original_b > 0 and compressed_b > 0:
                ...
                ratio = int(float(compressed_b) /
                            float(original_b) * 100 + 0.5)
                print("SUCCESS: " + target_filename)
...
class Gen_langfiles(threading.Thread):
    ...
    def _rebuild(self, srcs, dests):
        # Determine whether any of the files in srcs is newer than any in
        # dests.
        try:
    ...
    def run(self):
        ...
        if self._rebuild([os.path.join("msg", "messages.js")],
            ...
            try:
                ...
                # will be raised on failure, but I found that OSError is also
                # possible.
        ...
        for f in json_files:
            # This assumes the path to the current directory does not contain
            # "json".
            f = f.replace("json", "js")
            if os.path.isfile(f):
                print("SUCCESS: " + f)
...
if __name__ == "__main__":
    try:
        ...
        if os.path.isdir(os.path.join(os.path.pardir, "closure-library-read-only")):
            # Dir got renamed when Closure moved from Google Code to GitHub in
            # 2014.
            ...
            # calcdeps = import_path(os.path.join(
            # os.path.pardir, "google-closure-library", "closure", "bin",
            # "calcdeps.py"))
            print("Error: Closure directory needs to be renamed from"
